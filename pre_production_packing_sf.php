...
{
  check_new_equipment_packing_sf();
  $date1=$_REQUEST['date1'];
  $time1=$_REQUEST['time1'];
  $initial=$_REQUEST['chk_by'];
  $comment=$_REQUEST['comment'];
  
  insert_pre_production_packing_sf($date1,$time1,$initial,$comment);
  header("location:production_checks_packing_sf.php");
        ...
        <div class="row">
           <div class="col-md-8 col-lg-6 col-sm-12 ">
            ...
            <table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
              <?php
                if($ch_ppps_flag==1 && $_SESSION['u_type']!="admin")
                {
              ?>
            	<tr>
