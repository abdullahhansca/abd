...
if(isset($_REQUEST['submit']))
{
 ...
 $q="INSERT INTO `product` (`prd_id`, `prd_code`, `prd_name`, `prd_desc`, `prd_status`) VALUES (NULL, '$code', '$name', '$desc', '$status')";
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <div class="card-title" style="margin-left:20%"><h1>ADD PRODUCT</h1></div>
      </div>
      <div class="card-body">
        <div class="row">
...
<p>&nbsp;</p>
<h1 align="center">ADDED PRODUCTS </h1>
<table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
  ...
  <tr>
    ...
    <td><?php if($row['prd_status']==1){ echo "Active"; } else { echo "Deactive"; } ?></td>
	<td><a href="edit_product.php?prd_eid=<?php echo $row['prd_id']; ?>">Edit</a></td>
  </tr>
  <?php
  $count++;
  }
