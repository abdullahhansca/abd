...
include_once("header.php");
  ...
  $pp_ck="select ppps_date from pre_production_packing_sf WHERE ppps_date='$date1'";
  $pp_ck1=mysqli_query($conn,$pp_ck);
  if(mysqli_num_rows($pp_ck1)==0)
  {
	   echo "<script>alert('Please complete Pre Production Check(2nd Floor Packing)');</script>";
  }
 else
  {	
...
{
  check_new_equipment_clening_packing_sf();
  $date1=$_REQUEST['date1'];
  $time1=$_REQUEST['time1'];
  $initial=$_REQUEST['chk_by'];
  $comment=$_REQUEST['comment'];
  
  insert_cleaning_log_packing_sf($date1,$time1,$initial,$comment);
          ...
          <div class="col-md-6 col-lg-6 col-sm-12 ">
            <form action="" method="post">
              ...
              <?php
               ...
               ?>
              	<tr>
                  <th colspan="3" align="center"><h2 align="center"><strong>Cleaning Log already submitted for Today</strong></h2></th>
                </tr>
              <?php	
                }
                else
               ...
               <thead>
                <tr>
                  <th colspan="3" align="center"><h2 align="center"><strong>Cleaning Log </strong> (Second Floor Packing Area) </h2> 
