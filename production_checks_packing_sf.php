        ...
        <div class="row">
           <div class="col-md-6 col-lg-6 col-sm-12 ">
            <table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
                <?php
                  if($ch_cps_flag==1 && $_SESSION['u_type']!="admin")
                  {
                 ?>
                	<tr>
                ...
                <?php	
                 ...
                 <thead>
                  <tr>
                    <th colspan="2" scope="row"><span class="style2">ADD PACKING PRODUCT (2nd Floor) </span></th>
                  </tr>
                  </thead>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="selectgroup w-100">    
                         <label class="selectgroup-item">
                           <input type="radio" value="1" name="app" class="selectgroup-input" style="border:1;border-color:<?php echo $color; ?>" required = "required"/>
                           <span class="selectgroup-button">PASS</span>
                         </label>
                         <label class="selectgroup-item">
...
if(isset($_REQUEST['prd_id']))
  ...
  elseif(isset($_SESSION['date']) && $_SESSION['u_type']=="admin")
   ...
   $d="select *from production_check_packing where prd_pk_date='$date1' AND prd_pk_loc=2 ORDER BY prd_pk_id DESC";
...
?>	  
      <tr>
        ...
        <td><a href="print_test.php?name=<?php echo $p_name.' ('.$p_sub_name.')'; ?>&batch=<?php echo $p_batch; ?>&date=<?php echo $p_date; ?>&page=<?php echo "pack_2"; ?>">Print</a></td>
      </tr>
