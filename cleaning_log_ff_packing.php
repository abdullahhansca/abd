...
include_once("header.php");
  ...
  $pp_ck="select pppf_date from pre_production_packing_ff WHERE pppf_date='$date1'";
  ...
  $pt_ck="select trp_date from traceability_packing WHERE trp_date='$date1'";
  ...
  L1: if($f2==1) { echo "<script>alert('Please complete Pre Production Check(1st Floor Packing)');</script>"; }
	  if($f3==1) { echo "<script>alert('Please complete Treceability Check(1st Floor Packing)');</script>"; }

if($f2==0 && $f3==0)
{
if(isset($_REQUEST['submit']))
{
  check_new_equipment_clening_packing_ff();
  $date1=$_REQUEST['date1'];
  $time1=$_REQUEST['time1'];
  $initial=$_REQUEST['chk_by'];
  $comment=$_REQUEST['comment'];
  
  insert_cleaning_log_packing_ff($date1,$time1,$initial,$comment);
            ...
            <form action="" method="post">
              <table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
                 ...
                 <?php	
                  ...
                  <thead>
                   <tr>
                     <th colspan="3" align="center"><h2 align="center"><strong>Cleaning Log </strong> (First Floor Packing Area) </h2> 
