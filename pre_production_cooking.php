...
if(isset($_REQUEST['submit']))
{
  ...
  insert_pre_production_cooking($date1,$time1,$initial,$comment);
           ...
           <div class="col-md-8 col-lg-6 col-sm-12 ">
              <form action="" method="post">
                <table class="table table-bordered table-head-bg-info table-bordered-bd-info mt-4">
                 <?php
                  if($ch_ppc_flag==1 && $_SESSION['u_type']!="admin" )
                  {
                 ?>
                	<tr>
                ...
                <?php	
                 ...
                 ?>
                  <tr>
                    <thead>
                      <th colspan="3" align="center"><h2 align="center"><strong>Pre Production Checks</strong><br> (Cooking Area) </h2> Date : </strong><input style="padding:1%" type="date" name="date1" value="<?php $displayDate = date('Y-m-d', strtotime($_SESSION['date']));  echo $displayDate; ?>"  /></th>
                    </thead>
                    </tr>
                  <tr>
                    <thead>
